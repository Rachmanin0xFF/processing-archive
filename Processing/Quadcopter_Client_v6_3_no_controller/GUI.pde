...
void initGUI() {
  throddle = new Slider(10, 570, 1020, 100, "THROTTLE");
  throddle.display_value = true;
  throddle.set_theme(bTheme);
...
void updateGUI() {
  ...
  CONTROL_X_EASED = xyControllerPad.value_x;
  CONTROL_Y_EASED = xyControllerPad.value_y;
  CONTROL_X = xyControllerPad.value_x;
  CONTROL_Y = xyControllerPad.value_y;
...
void mouseWheel(MouseEvent me) {
  ...
  throddle.update_scroll(me.getCount());
}
