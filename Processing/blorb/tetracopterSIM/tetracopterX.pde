public class TetracopterX {
  ...
  public void movement() {
    ...
    strokeWeight(.04*50);//ADJUST STROKEWEIGHT 2
    realVel.displayCol(x, y, z);
    strokeWeight(.02*50);//ADJUST STROKEWEIGHT
  }
  ...
  public void physics() {
    ...
    cubeView.strokeWeight(.12*5); //ADJUST STROKEWEIGHT 6
  ...
  public void drawSpeeds() {
    cubeView.lights();
    float k = 300;
    cubeView.strokeWeight(.005*50);//ADJUST STROKEWEIGHT
    cubeView.stroke(0);
    ...
    cubeView.strokeWeight(.10*50);//ADJUST STROKEWEIGHT 5
