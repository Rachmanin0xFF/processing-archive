...
dVec3 abs_components(dVec3 a) {
  return new dVec3(a.x>0?a.x:-a.x, a.y>0?a.y:-a.y, a.z>0?a.z:-a.z);
}
...
dVec3 mandelbulb_cube(dVec3 a) {
  return new dVec3((3*a.z*a.z-a.x*a.x-a.y*a.y)*a.x*(a.x*a.x-3.0*a.y*a.y)/(a.x*a.x+a.y*a.y),
                   (3*a.z*a.z-a.x*a.x-a.y*a.y)*a.y*(3.0*a.x*a.x-a.y*a.y)/(a.x*a.x+a.y*a.y),
                   a.z*(a.z*a.z-3.0*a.x*a.x-3.0*a.y*a.y));
}
dVec3 complex_square(dVec3 a) {
  return new dVec3(a.x*a.x - a.y*a.y, 2.0*a.x*a.y, a.z);
}
